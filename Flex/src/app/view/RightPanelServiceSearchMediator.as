package app.view
{
	...
	public class RightPanelServiceSearchMediator extends Mediator implements IMediator
	{
		public static const NAME:String = "RightPanelServiceSearchMediator";
				
		//private var listOriginRoad:ArrayCollection = null;
		
		public function RightPanelServiceSearchMediator(viewComponent:Object=null)
		{
			super(NAME, viewComponent);
			
			rightPanelServiceSearch.addEventListener(RightPanelServiceSearch.COMBOTEXTCHANGE,onComboTextChange);
			
			//rightPanelServiceSearch.addEventListener(RightPanelServiceSearch.ROAD2TEXTCHANGE,onComboTextChange);			
			rightPanelServiceSearch.addEventListener(RightPanelServiceSearch.CROSSROADCHANGE,onCrossRoadChange);			
			...
			rightPanelServiceSearch.addEventListener(RightPanelServiceSearch.ADDRESSTEXTCHANGE,onAddressTextChange);
			rightPanelServiceSearch.addEventListener(RightPanelServiceSearch.RADIOCUSTOMCHANGE,onRadioCustomChange);
						
			rightPanelServiceSearch.addEventListener(RightPanelServiceSearch.MAPLOCATE,onMapOperator);
			rightPanelServiceSearch.addEventListener(RightPanelServiceSearch.MAPSEARCH,onMapOperator);
			
			rightPanelServiceSearch.addEventListener(RightPanelServiceSearch.GRAPHICCHANGE,onBarGraphicChange);
									
			rightPanelServiceSearch.addEventListener(RightPanelServiceSearch.SEARCH,onSearchPolice);
		}
		
		protected function get rightPanelServiceSearch():RightPanelServiceSearch
		{
			return viewComponent as RightPanelServiceSearch;
		}
